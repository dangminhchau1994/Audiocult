...
class _TicketCartScreenState extends State<TicketCartScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CommonAppBar(title: 'Your cart'),
      body: Container(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text('${e.count ?? ''}'),
                                Row(
                                  children: [Text(cart?.currency ?? ''), Text('${e.price?.gross}')],
                                ),
                                Row(
                                  children: [
                                    Text(
                                      cart?.currency ?? '',
                                      style:
                                          context.bodyTextStyle()?.copyWith(fontWeight: FontWeight.w700, fontSize: 24),
                                    ),
                                    Text(
