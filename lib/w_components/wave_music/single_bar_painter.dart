  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
        RRect.fromRectAndRadius(
            Rect.fromLTWH(startingPosition, -heightOfContainer / 1.9, singleBarWidth, outerSideHeight / 2),
            Radius.circular(0)),
        aboveAndBelowPaint);
    canvas.drawRRect(
        RRect.fromRectAndRadius(
            Rect.fromLTWH(
                startingPosition, outerSideHeight / 2 - heightOfContainer / 2, singleBarWidth, actualSeekBarHeight),
            Radius.circular(barBorderRadius)),
        trackPaint);
    canvas.drawRRect(
        RRect.fromRectAndRadius(
            Rect.fromLTWH(startingPosition, (outerSideHeight / 2) - heightOfContainer / 2 + actualSeekBarHeight,
                singleBarWidth, outerSideHeight / 2),
            Radius.circular(0)),
        aboveAndBelowPaint);
    canvas.drawRRect(
        RRect.fromRectAndRadius(
            Rect.fromLTWH(startingPosition, -heightOfContainer / 2, 0.2 * singleBarWidth, heightOfContainer),
            Radius.circular(0)),
        aboveAndBelowPaint);
  }
